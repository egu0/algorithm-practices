...
public class MaxHeight1691 {
    ...
    public static void main(String[] args) {
        ...
        Assertions.assertSame(o.maxHeight(new int[][]{{50, 45, 20}, {95, 37, 53}, {45, 23, 12}}), 190);
        Assertions.assertSame(o.maxHeight(new int[][]{{38, 25, 45}, {76, 35, 3}}), 76);
        Assertions.assertSame(o.maxHeight(new int[][]{{7, 11, 17}, {7, 17, 11}, {11, 7, 17}, {11, 17, 7}, {17, 7, 11}, {17, 11, 7}}), 102);
    }
